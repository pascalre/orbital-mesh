...
const PROVIDER_OPTIONS = ["*", "CENTISPACE", "COSMO", "ERMIS", "FEMTO", "GLONASS", "GPS", "HADES", "HAWK", "HULIANWANG", "IRNSS", "JACK", "JILIN", "KUIPER", "LPNTSAT", "ONEWEB", "OPTISAT", "PARUS", "PROGRESS", "QIANFAN", "RASSVET", "SHIYAN", "SPOQC", "STARLINK", "STRIX", "SUPERVIEW", "TEN", "TRANSPORTER", "XINZHENGCHENG"];
